...
public final class SetDispatchChannelCommand implements ApplicationCommand {
    ...
    public String getName() {
        return ApplicationCommand.NAME_PREFIX + "set-dispatch-channel";
    }

    @Override
    public String getShortDescription() {
        return "Sets the channel to send daily questions to";
    }
    ...
    public Mono<?> onInteraction(ApplicationCommandInteractionEvent event) {
        ...
        settings.setQuestionChannel(channelId);

        return event.reply()
            .withContent(Branding.getQuestionChannelSetSuccessfulMessage(channelId));
    }
